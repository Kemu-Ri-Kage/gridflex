> **Status, 22 Sep 2026: implemented.** The copy and both behaviour notes
> below are in `trade-panel.tsx`, `web3-provider.tsx`, `wallet-button.tsx`
> and `order-column.tsx`; the ticket now follows the selected market (see
> `NOTES.md`). Kept as the record of what was asked for and why.
